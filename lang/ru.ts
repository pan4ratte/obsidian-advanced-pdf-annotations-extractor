export default {
    ...
    SETTING_SORT_BY_TOPIC_DESC: "Распознаёт первую строку каждого комментария как тему и группирует по ней внутри всех остальных группировок.",
    ...
    SETTING_FILE_HEADING_DESC: "Добавляет заголовок с именем папки или файла: он отмечает каждую группу, когда включена соответствующая группировка, и озаглавливает всю заметку, когда имя одно на всю заметку.",
